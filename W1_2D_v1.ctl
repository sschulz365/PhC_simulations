...
(if (= k-split-index 0)  ;only print this info out on the first node of mbi-split calculations
    (begin
      (print "********************* h e l l o ************************** \n")
      (print "PHOTONIC CRYSTAL SLAB DISPERSION ENGINEERED WAVEGUIDE CALCULATION in 2D\n")
      (print "VERSION 1 - Sebastian Schulz 01 June 2015 \n")
      (print "Script by Sebastian Schulz - please see him for help and modifications \n")
      (print "Based on the 3D Dispersion Engineered PhC code by Daryl Beggs and Sebastian Schulz \n\n")
...
(define-param index-slab 3.48)   ;refractive index of slab material, default is Silicon (3.48). For effective period method use the index of the bulk material
(define-param index-holes 1.0)  ;refractive index of hole and cladding materials, default is air (1.0)
...
(set! geometry (list
		(make block  ;define slab with slab-material and size of the unit cell in x,y but infinite in z
		  (center 0 0 0) 
